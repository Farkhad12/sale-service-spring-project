...
public class ProductServiceImpl implements ProductService {
    ...
    public ResponseEntity<?> saveProduct( ProductDto productDto) {
        ...
        Random r = new Random();
      String s = String.format("%04d",Integer.valueOf(r.nextInt(10010101)));
        productDto.setBarcode(s);
    ...
    @Override
    public int getQuantityProductByBarcode(String barcode) {
        int amount = productRepo.getProductQuantityByBarcode(barcode);
        return amount;
    }
